      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: theme.spacing['Space.M'] }}>
          ...
          {waterConfig.useColorRamp && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: theme.spacing['Space.M'], marginTop: theme.spacing['Space.S'] }}>
                  <Select
                      ...
                      options={[
                          { value: 'ramp-simplex', label: 'Simplex (Default)' },
                          { value: 'ramp-perlin', label: 'Perlin' },
                          { value: 'ramp-voronoi', label: 'Voronoi (Cellular)' },
                      ]}
                  />
        ...
        <Accordion title="Waves">
          <Select
              ...
              options={[
                  { value: 'wave-simplex', label: 'Simplex (Default)' },
                  { value: 'wave-perlin', label: 'Perlin' },
                  { value: 'wave-voronoi', label: 'Voronoi (Cellular)' },
              ]}
           />
          ...
          {waterConfig.useNoiseLayerB && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: theme.spacing['Space.M'], marginTop: theme.spacing['Space.S'] }}>
                  <Select
                      ...
                      options={[
                          { value: 'blend-mix-ab', label: 'Mix' },
                          { value: 'blend-add-ab', label: 'Add' },
                          { value: 'blend-multiply-ab', label: 'Multiply' },
                      ]}
                  />
                  ...
                  <Select
                      ...
                      options={[
                          { value: 'wave-b-simplex', label: 'Simplex' },
                          { value: 'wave-b-perlin', label: 'Perlin (Default)' },
                          { value: 'wave-b-voronoi', label: 'Voronoi (Cellular)' },
                      ]}
                  />
            ...
            {waterConfig.useNoiseLayerC && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: theme.spacing['Space.M'], marginTop: theme.spacing['Space.S'] }}>
                    <Select
                        ...
                        options={[
                            { value: 'blend-add-bc', label: 'Add' },
                            { value: 'blend-multiply-bc', label: 'Multiply' },
                            { value: 'blend-mix-bc', label: 'Mix' },
                        ]}
                    />
                    ...
                    <Select
                        ...
                        options={[
                            { value: 'wave-c-simplex', label: 'Simplex (Default)' },
                            { value: 'wave-c-perlin', label: 'Perlin' },
                            { value: 'wave-c-voronoi', label: 'Voronoi (Cellular)' },
                        ]}
                    />
